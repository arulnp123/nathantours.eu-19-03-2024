    ...
    <div class="page">
            ...
            <div class="col-sm-6 col-md-12 wow fadeInRight">
              ...
              <article class="product-big">
                <div class="unit flex-column flex-md-row align-items-md-stretch">
                  <div class="unit-left"><a class="product-big-figure" ><img src="photo/<?php echo $row['photo']; ?>" alt="" width="600" height="366"/></a></div>
                  <div class="unit-body">
                    <div class="product-big-body">
                      <h5 class="product-big-title"><?php echo $row['packages_name']; ?></h5>
                      ...
                      <p class="product-big-text"><?php echo $row['packages_description']; ?>...</p>
                      
                      <div class="product-big-price-wrap"><span class="product-big-price">€<?php echo $row['price']; ?></span></div>
                    </div>
                  </div>
                </div>
              </article>
      ...
      <div class="container">
          ...
          <form method="post" action="mail.php">
            <div class="row row-14 gutters-14">
              <div class="col-md-4">
                ...
                <div class="form-wrap">
                  ...
                  <input class="form-input"  type="hidden" name="packages_name" value="<?php echo $row['packages_name']; ?>" data-constraints="@Required">
                  <input class="form-input"  type="hidden" name="price" value="<?php echo $row['price']; ?>" data-constraints="@Required">
           ...
           <div class="row row-14 gutters-14">
           <div class="col-md-4">
              <label class="outer-label" for="name">Select Date:</label>
             <select  class="form-input" id="select" type="select" name="date" data-constraints="@Required" required>
              <option value="">--Please choose an option--</option>
            
              <?php $sql = "select * from tour_date_providing";

             $result = mysqli_query($conn, $sql);
             while ($row = mysqli_fetch_assoc($result))  {
             ?>
              <option value="<?php echo $row['tour_dates']; ?>"><?php echo $row['tour_dates']; ?></option>
              <?php } ?>
          </select>
            </div>
            <div class="col-md-4">
