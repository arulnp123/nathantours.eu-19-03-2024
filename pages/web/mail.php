...
<?php 
    ...
    $sql = "INSERT INTO  popular_tours_booking (packages_name ,name, email, confirm_email, select_date, phone, adult_over_12, kid_4_to_12_years, kid_below_4, message, created_at, updated_at, price) VALUES ('$packages_name', '$name', '$email', '$cemail', '$date', '$phone', '$adults', '$years', '$kids', '$message', '$created_at', '$updated_at' ,'$price')";
