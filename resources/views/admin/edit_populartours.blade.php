    ...
    @section('admin/content')
          ...
          <div class="col-6 grid-margin stretch-card">
            ...
            <div class="form-group">
                      ...
                      @foreach($popular->tourdate as $k=>$tour)
                            <tr  id="addr{{ $k }}">
                                <td><input value="{{ $tour->tour_date }}" type="date" name="addmore[0][tourdate]" 
...
<script type="text/javascript">
      var i = 0;
  @if(count($popular->tourdate) > 0)
    i = "{{ count($popular->tourdate)-1 }}";
    i = parseInt(i);
  @endif
