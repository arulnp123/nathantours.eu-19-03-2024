...
@section('content')
    <tr>
                            ...
                            <article class="product-big">
                                <div class="unit flex-column flex-md-row align-items-md-stretch">
                                    <div class="unit-left"><a class="product-big-figure"><img
                                                src="{{ URL::to('/') }}/assets/photo/{{ $hottourslist->photo }}"
                                    ...
                                    <div class="unit-body">
                                        <div class="product-big-body">
                                            ...
                                            <div class="product-big-price-wrap"><span
                                                    class="product-big-price">€{{ $hottourslist->price }}</span></div>
                                        </div>
                                    </div>
                                </div>
                            </article>
        ...
        <div class="container">
            ...
            <form method="post" action="{{ url('/bookdatap') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row row-14 gutters-14">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-wrap">
                            <input class="form-input" id="cemail" type="cemail" name="cemail"
                                data-constraints="@Required" required oninput="check(this)">
                ...
                <div class="row row-14 gutters-14">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <select class="form-input 1-100" id="days" name="days" data-constraints="@Required"
                                required>
                            </select>
                ...
                <div class="row">
                    <div class="col-4 col-sm-4">
                        ...
                        <label class="outer-label" for="Adults">Adults</label>

                        <div class="form-group">

                            <select class="form-input 1-100" id="Adults" name="adults" data-constraints="@Required"
                                required>
                            </select>
                            <span class="select-arrow"></span>
                        </div>
                    ...
                    <div class="col-4 col-sm-4">
                        <label class="outer-label" for="years">Kids(5y-10y)</label>
                        <div class="form-group">
                            <select class="form-input 1-100" id="years" name="years" data-constraints="@Required"
                                required>
                            </select>
                            <span class="select-arrow"></span>
                        </div>
                    ...
                    <div class="col-4 col-sm-4">
                        <label class="outer-label" for="kids">Kids(>10y)</label>
                                <div class="form-group">
                                    <select class="form-input 1-100" id="kids" name="kids"
                                        data-constraints="@Required" required>
                                    </select>
                                    <span class="select-arrow"></span>
                                </div>
                ...
                <div class="row row-14 gutters-14">
                    <div class="col-12">
                        ...
                        <div class="form-wrap">
                            ...
                            <input class="form-input" type="hidden" name="packages_name" value="{{ $hottour->packages_name }}"
                                data-constraints="@Required">
                            <input class="form-input" type="hidden" name="price" value="{{ $hottour->price }}"
                                data-constraints="@Required">
                        </div>
                    </div>
                    @endforeach
