...
Route::post('/bookdatap', 'App\Http\Controllers\Booknow2Controller@bookdatap');




Route::get('/admin/dashboard2', [App\Http\Controllers\DashboardController::class, 'dashboard2'])->name('dashboard2');